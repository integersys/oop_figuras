...
public class OIzveide {
	...
	static void izveidotObjektu() {
		...
		case 0:
			...
			JOptionPane.showMessageDialog(null, "Centra punkts izveidotds!", "Paziņojums", JOptionPane.INFORMATION_MESSAGE);
			break;
		...
		case 3:
			...
			int m1 = MinkuTante.skaitlaParbaude("Ievadi pirmās malas garumu", 1, 100);
			...
			JOptionPane.showMessageDialog(null, "Trījstūris izveidots!", "Paziņojums", JOptionPane.INFORMATION_MESSAGE);
